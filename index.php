...
<div class="container-fluid">
    ...
    <div class="slider-wrapper"><!-- innermost wrapper element -->
        <img src="assets/images/111.jpg" alt="First" class="slide" /><!-- slides -->
        <img src="assets/images/222.jpg" alt="Second" class="slide" />
    </div>
</div>  
        </div>
    </div>
           ...
           style="background-image: url('assets/images/baner.jpg')">
            <div class="row">
                <div class="col-lg-6 offset-lg-6">
                    <div class="organic-widget-content" style="height:150px">
                ...
                <div class="xs-tab-slider owl-carousel owl-theme">
                    <div class="xs-tab-slider-item">
                        <div class="xs-product-widget media">
                            <img class="d-flex" src="assets/images/new-brands/logoGPR.png" data-echo="assets/images/new-brands/logoGPR.png" alt="Mobile">
                        </div><!-- .xs-product-widget END -->
                    </div><!-- .xs-tab-slider-item END -->
                    <div class="xs-tab-slider-item">
                        <div class="xs-product-widget media">
                            <img class="d-flex" src="assets/images/new-brands/logo_idc.jpg" data-echo="assets/images/new-brands/logo_idc.jpg" alt="Mobile">
                    ...
                    <div class="xs-tab-slider-item">
                        ...
                        <div class="xs-product-widget media">
                            <img class="d-flex" src="assets/images/new-brands/logo.png" data-echo="assets/images/new-brands/logo.png" alt="Mobile">
                        </div><!-- .xs-product-widget END -->
                    ...
                    <div class="xs-tab-slider-item">
                        ...
                        <div class="xs-product-widget media">
                            <img class="d-flex" src="assets/images/new-brands/default_3.jpg" data-echo="assets/images/new-brands/default_3.jpg" alt="Mobile">
                        </div><!-- .xs-product-widget END -->
