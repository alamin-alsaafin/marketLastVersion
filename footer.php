            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-2 footer-widget">
                    ...
                    <ul class="xs-list">
                        ...
                        <li><a href="privateLabal.php">Private Labal</a></li>
                    </ul><!-- .xs-list END -->
                </div><!-- .footer-widget END -->
            </div>
        </div>
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane fadeInRights show fade in active" id="login">
                        <form action="#" method="POST" class="xs-customer-form">
                            ...
                            <button id="submit_login" type="submit_login" class="btn btn-primary btn-block">Login</button>
                    ...
                    <div role="tabpanel" class="tab-pane fadeInRights fade" id="signup">
                        <form action="#" method="POST" class="xs-customer-form">
                            ...
                            <div class="input-group input-group-append">
                                <input id="email_S" type="email" class="form-control" placeholder="Enter your email" >
                            ...
                            <div class="input-group input-group-append">
                                <input id="confirm_password" type="password" class="form-control" placeholder="Enter your confirm password" >
                                 <i class="icon icon-key2 input-group-text"></i>
                            </div>
...
<script src="assets/js/slick.js"></script>         <!-- End js file -->
