...
$('.go-down').click(function(){
    $('html, body').animate({scrollTop:702},1000);
});



 // function to minimize the hieght of header when scrolling down

               $(document).on("scroll", function(){
                if
                  ($(document).scrollTop() > 50){
                  $(".xs-navBar").addClass("mini-header");
                  $(".go-down").addClass("scrollDown-hidden");
                }
                else
                {
                  $(".xs-navBar").removeClass("mini-header");
                  $(".go-down").removeClass("scrollDown-hidden");
                }
              });  
(function($) {
"use strict";
...
wow = new WOW(
  ...
  // this function to scroll down in the home page when i cilck on some anchor tag 
...
$(function () {
                ...
                $('html, body').animate({scrollTop:1480},1000);
                 });
});